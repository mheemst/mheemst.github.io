  ...
  <body>
	  ...
	  <div class="row">
		...
		<div class="col-md" id="content">
				<h2>Visual Pun</h2>
		  			<img class="image-container-large-wide" src="images/onthesamepage.png" alt="test image">
		 				<p>It's nice when everyone's on the same page. This was made with photoshop.</p>
