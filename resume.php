...
<html lang="en">
  ...
  <body>
	  ...
	  <div class="row">
		...
		<div class="row">
				<h2 id="resume-page-h2">Resume</h2>
					<div class="col-sm" id="resume-object">
					<object width="60%" height="600px" data="objects/resume.pdf">
					</object>
			</div>
		</div>
		
		<div class="row">
			<div class="col-sm" id="mobile-resume">
					<img id="mobile-resume-img" src="images/resume-img.png" alt="image of resume" class="img-fluid"><br/>
					<a href="https://mheemst.github.io/objects/resume.pdf" target="_blank"><button>See PDF in New Tab</button></a>
			</div>
		</div>
