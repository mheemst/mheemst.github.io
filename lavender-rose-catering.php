  ...
  <body>
	  ...
	  <div class="row">
		...
		<div class="col-md" id="content">
				<h2>Android Violet Parr (The Incredibles)</h2>
		  			<img class="image-container-large-wide" src="images/lavender-rose-catering.png" alt="banner for Lavender Rose Catering">
		 				<p>"Lavender Rose Catering" is a nonexistent catering business created by my girlfriend. I put together this mockup banner in Photoshop to illustrate her idea.</p>
